...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://lostfrequenci.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("lostfrequency");
        driverTrello.findElement(By.id("password")).sendKeys("notforall69");
        driverTrello.findElement(By.id("login")).submit();

        Thread.sleep(4000);

        driverTrello.navigate().to("https://trello.com/b/CUs81PRO/kodilla-application");
        /*driverTrello.findElements(By.xpath("//a[@class=\"board-title\"]")).stream()
                .filter(aHref -> aHref.findElements(By.xpath(".//div[contains(@class=\"board-tile-details is-badged\")]")).size()>0)
